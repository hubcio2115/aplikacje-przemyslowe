...
public interface CountryRepository extends CrudRepository<Country, Long> {
    ...
    @Query("SELECT c.id, c.name, c.formationYear, c.gdp, c.isInEurope FROM Country c JOIN FETCH c.citizens, c.cities, c.ruler WHERE c.id = :id")
    List<Country> findAllWithCitizens();
}
