...
public class CountryController {
    ...
    public ResponseEntity<Optional<Country>> getByNameAndFormationYear(@RequestParam String name, @RequestParam Year formationYear) {
    ...
    public ResponseEntity<Optional<Country>> getByNameOrFormationYear(@RequestParam String name, @RequestParam Year formationYear) {
