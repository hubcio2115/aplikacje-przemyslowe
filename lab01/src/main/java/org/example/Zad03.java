...
public class Zad03 {
    private final double YEAR_ON_EARTH_IN_SECONDS = 31557600;
    private final Map<Planets, Double> YEAR_ON_PLANETS_IN_SECONDS = Map.of(
    ...
    public static void zad03(int age, Planets planet) {
